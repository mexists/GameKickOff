            ...
            <div class="container bg-border">
                <div class="row">
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <h1 class="purchae-hed">Excellent Real-time Water Level Monitoring for River</h1></div>
                    <div class="col-md-5 col-sm-5 col-xs-12"><a href="#" class="btn btn-primary purchase-styl pull-right">Subscribe now</a></div>
                </div>
            </div>
        </section>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('assets/images/mizan.jpg') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>Mizan Noor</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('assets/images/hana.jpg') }}" alt="team-image">
                    <div class="caption">
                        <b>Dr. Hanayanti</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('assets/images/adib.jpg') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>PM Dr. Adib Razi</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('assets/images/hairuln.jpg') }}" alt="team-image">
                    <div class="caption">
                        <b>PM Dr. Hairul Nizam</b>
                        <br /> Founder & Partner
                        <br />
                        <div class="divide">
                            <a href="#" class="divider"> <i class="livicon" data-name="facebook" data-size="22" data-loop="true" data-c="#3a5795" data-hc="#3a5795"></i>
