...
<body>
                    ...
                    <li class="pull-right">
                        <ul class="list-inline icon-position">
                            <li>
                                ...
                                <label class="hidden-xs"><a href="mailto:" class="text-white">mizannoor92@gmail.com</a></label>
                            </li>
                            <li>
                                <a href="tel:"><i class="livicon" data-name="phone" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a>
                                <label class="hidden-xs"><a href="tel:" class="text-white">+1 (866) 223-3879</a></label>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @endif
                    <li class="dropdown {!! (Request::is('aboutus') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : '') !!}"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Site</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ URL::to('aboutus') }}">About Us</a></li>
                            <li><a href="{{ URL::to('historical') }}">Historical Data</a></li>
                            @if(!Sentinel::guest())
                            ...
                            <li><a href="{{ URL::to('blank_page') }}">Blank</a></li>
                            @endif
                        </ul>
                    </li>
                    @if(!Sentinel::guest())
                    ...
                    <li {!! (Request::is('blog') || Request::is('blogitem/*') ? 'class="active"' : '') !!}><a href="{{ URL::to('blog') }}"> Blog</a></li>
                    @endif
        ...
        <div class="container footer-text">
            ...
            <div class="col-sm-4">
                ...
                <ul class="list-unstyled">
                    <li>No.21 Jln Setia Kasih 1</li>
                    <li>Melaka, Malaysia.</li>
                    <li><i class="livicon icon4 icon3" data-name="cellphone" data-size="18" data-loop="true" data-c="#ccc" data-hc="#ccc"></i>Phone:+60 19-689 6594</li>
                    <li><i class="livicon icon4 icon3" data-name="printer" data-size="18" data-loop="true" data-c="#ccc" data-hc="#ccc"></i> Fax:+1 (866) 223-3879</li>
    ...
    <div class="copyright">
        <div class="container">
        <p>Copyright &copy; Real-time WaLM, {{date('Y')}}</p>
        </div>
    </div>
    ...
    <script>
        // Initialize Firebase
        var config = {
            apiKey: "AIzaSyBm2olh41vxeYbByg6xodjOHpjyG_vGo9w",
            authDomain: "real-time-walm-40ec6.firebaseapp.com",
            databaseURL: "https://real-time-walm-40ec6.firebaseio.com",
            storageBucket: "real-time-walm-40ec6.appspot.com",
            messagingSenderId: "736830938474"
        };
